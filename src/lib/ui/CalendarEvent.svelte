<script lang="ts">
  ...
  let officeLink      = makeOutlookInvite(true, date,
    title,
    description,
    address
  );
...
<div class='add-event'
  ...
  {#if shown}
    <div class='add-links'
         ...
         on:keypress>
      <a href='https://calendar.google.com/calendar/event?action=TEMPLATE&tmeid=NHB2MWkzNm8ybnVqbGdlamJ0a3BjdThvaDkgYjBjNGNkMzI4NjcxNzFkOTdhZjc5NzZhMzBhMTBhYWE2NDIxMTNmOWM4M2MyNmU5ZjBhMzM3YTU5NTEzM2UyOEBn&tmsrc=b0c4cd32867171d97af7976a30a10aaa642113f9c83c26e9f0a337a595133e28%40group.calendar.google.com'
         target='_blank'
         class='invite'>
      ...
      <a href={officeLink}
         target="_blank"
         class='invite'>
        <img src='data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciICB2aWV3Qm94PSIwIDAgNDggNDgiIHdpZHRoPSI0OHB4IiBoZWlnaHQ9IjQ4cHgiPjxwYXRoIGZpbGw9IiNlNjRhMTkiIGQ9Ik03IDEyTDI5IDQgNDEgNyA0MSA0MSAyOSA0NCA3IDM2IDI5IDM5IDI5IDEwIDE1IDEzIDE1IDMzIDcgMzZ6Ii8+PC9zdmc+'
             alt='365'> 365
      </a>
    </div>
  {/if}
